        ...
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="max-w-xl z-10">
            ...
            <p className="text-xl mb-8 text-black">
              Advanced AI-powered solution to protect your business from
              counterfeit products
            </p>
            <Link href="/dashboard">
              <button className="bg-black text-brand px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90 cursor-pointer">
                Get Started
              </button>
            </Link>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Instant analysis of products using advanced AI algorithms",
                icon: "/images/real-time.png",
              },
              {
                title: "High Accuracy",
                description:
                  "99.9% accurate results with minimal false positives",
